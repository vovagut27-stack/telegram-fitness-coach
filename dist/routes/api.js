...
import { getWorkoutByDate, markWorkoutCompleted, saveExerciseLog, } from "../database/workouts-repo.js";
import { canGenerateWorkout, ensureDefaultUser, getOrCreateTodayWorkout, } from "../services/workout-service.js";
...
apiRouter.post("/workout/complete", async (req, res) => {
    const { telegramId, completionNotes, exercises } = req.body;
