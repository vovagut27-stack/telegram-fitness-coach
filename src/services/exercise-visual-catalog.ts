...
const NAME_TO_MOVEMENT: Array<{ pattern: RegExp; key: MovementKey }> = [
  ...
  { pattern: /bench|жим.*лёж|жим.*леж|жим.*гантел|incline|decline|наклонн/i, key: "press" },
  { pattern: /row|тяга|гребл|pulldown|блок|горизонтальн|гравитрон/i, key: "row" },
  { pattern: /штанг|barbell|гантел|dumbbell/i, key: "press" },
