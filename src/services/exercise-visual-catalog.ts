...
const EXACT_WGER: Record<string, MovementKey> = {
  ...
  [normalizeExerciseName("Жим штанги в наклоне")]: "press",
  [normalizeExerciseName("Incline barbell press")]: "press",
  [normalizeExerciseName("Жим гантелей на наклонной")]: "press",
  [normalizeExerciseName("Incline dumbbell press")]: "press",
  [normalizeExerciseName("Разводка гантелей лежа")]: "fly",
  [normalizeExerciseName("Dumbbell chest fly")]: "fly",
  [normalizeExerciseName("Разводка гантелей")]: "fly",
  [normalizeExerciseName("Dumbbell flyes")]: "fly",
  [normalizeExerciseName("Подтягивания")]: "pull",
  [normalizeExerciseName("Pull-ups")]: "pull",
