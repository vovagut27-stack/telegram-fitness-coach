...
const EXACT_SLUG: Record<string, IllustrationSlug> = {
  ...
  [normalizeExerciseName("Тяга полотенца к поясу")]: "hip-hinge",
  [normalizeExerciseName("Towel door rows")]: "hip-hinge",
  [normalizeExerciseName("Тяга в наклоне с рюкзаком")]: "hip-hinge",
  [normalizeExerciseName("Backpack bent-over rows")]: "hip-hinge",
  ...
  [normalizeExerciseName("Кроссовер / блок")]: "cable-crossover",
  [normalizeExerciseName("Cable crossover")]: "cable-crossover",
  [normalizeExerciseName("Разгибание на блоке (трицепс)")]: "cable-triceps",
  [normalizeExerciseName("Cable triceps pushdown")]: "cable-triceps",
